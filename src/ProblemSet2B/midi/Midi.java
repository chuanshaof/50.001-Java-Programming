...
public class Midi {
    ...
    public final static ProblemSet2B.midi.Instrument DEFAULT_INSTRUMENT = Instrument.PIANO;
    
    // active MIDI channels, assigned to instruments
    private final Map<ProblemSet2B.midi.Instrument, MidiChannel> channels = new HashMap<ProblemSet2B.midi.Instrument,MidiChannel>();
     ...
     */
    public void play(int note, int duration, ProblemSet2B.midi.Instrument instr) {
     ...
     * @param instr: instrument in midi.Instrument enum.
     */
    public void beginNote(int note, ProblemSet2B.midi.Instrument instr) {
        MidiChannel channel = getChannel(instr);
        synchronized (channel) {
            channel.noteOn(note, VELOCITY);
        }
     ...
     * @param instr: instrument in midi.Instrument enum.
     */
    public void endNote(int note, ProblemSet2B.midi.Instrument instr) {
        MidiChannel channel = getChannel(instr);
        synchronized (channel) {
     ...
     */
    private void log(int note, ProblemSet2B.midi.Instrument instr, boolean isNoteOn) {
     ...
     * modifies this
     */
    private MidiChannel getChannel(ProblemSet2B.midi.Instrument instr) {
     ...
     * @param instr
     */
    private void patchInstrumentIntoChannel(MidiChannel channel, ProblemSet2B.midi.Instrument instr) {
